...
import FacultyRegister from "./components/login/facultyLogin/FacultyRegister";
import Login from "./components/login/Login";

import StudentLogin from "./components/login/studentLogin/StudentLogin";
import StudentRegister from "./components/login/studentLogin/StudentRegister";
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/login/facultyregister" element={<FacultyRegister />} />
