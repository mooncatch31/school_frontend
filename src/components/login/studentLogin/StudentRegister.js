...
const StudentRegister = () => {
  ...
  const Register = (e) => {
    ...
    dispatch(
      studentRegister({ email: username, password: password }, navigate)
    );
  };
    ...
    <div className="bg-[#d65158] h-screen w-screen flex items-center justify-center">
      <div className="grid grid-cols-2">
        ...
        <form
          ...
          <h1 className="text-white text-3xl font-semibold">Taker</h1>
          ...
          :
          <button
            // disabled={username !== "" && password !== '' && password == confirmpassword ? true : false}
            type="submit"
